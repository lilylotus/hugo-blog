...
date: 2023-09-05T02:56:00+08:00
lastmod: 2023-09-05T02:56:00+08:00
draft: false
...
`link` shortcode 是 [Markdown 链接语法](../markdown-基础语法/#links) 的替代.
`link` shortcode 可以提供一些其它的功能并且可以在代码块中使用.

{{< version 0.2.10 >}} 支持[本地资源引用](../主题文档-拓展-shortcodes/#music)的完整用法.
...
```markdown
{{</* friend "Lily" "https://github.com/lilylotus/" "https://avatars.githubusercontent.com/u/52968553?v=4" "This is Lily~💤" */>}}
或者
{{</* friend name="Lily" url="https://github.com/lilylotus/" avatar="https://avatars.githubusercontent.com/u/52968553?v=4" bio="This is Lily~💤" */>}}
```
...
```markdown
{{</* showcase title="Theme Documentation - Basics" summary="Discover what the Hugo - DoIt theme is all about and the core-concepts behind it." image="https://hugodoit.pages.dev/theme-documentation-basics/featured-image.webp" link="https://hugodoit.pages.dev/theme-documentation-basics/" */>}}
Or
{{</* showcase "Theme Documentation - Basics" "Discover what the Hugo - DoIt theme is all about and the core-concepts behind it." "https://hugodoit.pages.dev/theme-documentation-basics/featured-image.webp" "https://hugodoit.pages.dev/theme-documentation-basics/" */>}}
```

呈现的输出效果如下:

{{< showcase title="主题文档 - 基本概念" summary="探索 Hugo - DoIt 主题的全部内容和背后的核心概念." image="https://hugodoit.pages.dev/theme-documentation-basics/featured-image.webp" link="https://hugodoit.pages.dev/theme-documentation-basics/" >}}
