...
如果你想了解 **DoIt** 主题的扩展 Markdown 语法, 请阅读 [扩展 Markdown 语法页面](https://hugodoit.pages.dev/zh-cn/theme-documentation-content#extended-markdown-syntax).
{{< /admonition >}}
...
{{< admonition tip >}}
**DoIt** 主题提供了一个包含更多功能的 [图片的 shortcode](https://hugodoit.pages.dev/zh-cn/theme-documentation-extended-shortcodes#image).
{{< /admonition >}}
